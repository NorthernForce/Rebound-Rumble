...
FRCXboxJoystick::FRCXboxJoystick(int port): 
	Joystick(port),
     A(this, k_XBoxButtonA),
     B(this, k_XBoxButtonB),
     X(this, k_XBoxButtonX),
     Y(this, k_XBoxButtonY),
     Back(this, k_XBoxButtonBack),
     Start(this, k_XBoxButtonStart),
     LeftBumper(this, k_XBoxButtonLeft),
     RightBumper(this, k_XBoxButtonRight)
{
 	CalculateDeadband();
}
